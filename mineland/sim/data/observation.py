...
class Observation:
    ...
    def __init__(
        ...
        for name, value in local_vars.items():
            ...
            # === Scoreboard - Extract individual values as attributes ===
            elif name == 'scoreboard' and isinstance(value, dict):
                setattr(self, name, value)
                # Also set each scoreboard value as a direct attribute for easy access
