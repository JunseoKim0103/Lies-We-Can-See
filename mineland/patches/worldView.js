  ...
  listenToBot (bot) {
    ...
    this.listeners[bot.username] = {
      ...
      entitySpawn: function (e) {
        ...
        worldView.emitter.emit('entity', { id: e.id, name: e.name, pos: e.position, width: e.width, height: e.height, username: e.username, equipment: e.equipment })
      },
      ...
      entityEquip: function (e) {
        if (e === bot.entity) return
        worldView.emitter.emit('entity', { id: e.id, name: e.name, pos: e.position, width: e.width, height: e.height, username: e.username, equipment: e.equipment, equipmentChanged: true })
      },
    ...
    for (const id in bot.entities) {
      ...
      if (e && e !== bot.entity) {
        this.emitter.emit('entity', { id: e.id, name: e.name, pos: e.position, width: e.width, height: e.height, username: e.username, equipment: e.equipment })
      }
    }
  }
